  ...
  return (
    <section id="menu" className="relative py-20 lg:py-28">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* 3 × 2 grid on desktop, horizontal scroll on mobile */}
        <div className="lg:grid lg:grid-cols-3 gap-6 lg:gap-7 flex overflow-x-auto no-scrollbar -mx-4 px-4 lg:mx-0 lg:px-0 snap-x snap-mandatory">
          {items.map((item, i) => {
            ...
            return (
              <motion.div
                ...
                className="group shrink-0 w-[80%] sm:w-[55%] lg:w-auto snap-start lg:snap-align-none"
              >
                <motion.article
