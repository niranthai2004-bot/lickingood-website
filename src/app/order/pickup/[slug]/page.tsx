...
import { ArrowLeft, MapPin, Minus, Phone, Plus, X } from "lucide-react";
...
export default function PickupMenuPage() {
  ...
  // - Bundle mode + dozen-eligible: show bundle qty
  // - Otherwise: show cart qty (just for that item line)
